...
for i = 1:length(test_scenes)     
    ...
    for scale = scales
        ...
        curscale_bboxes = [feature_params.hog_cell_size * detected_x + 1, feature_params.hog_cell_size * detected_y + 1, ...
            feature_params.hog_cell_size * (detected_x + feature_params.template_size / feature_params.hog_cell_size), feature_params.hog_cell_size * (detected_y + feature_params.template_size / feature_params.hog_cell_size)]./scale;
